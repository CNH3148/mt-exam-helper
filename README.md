...
```bash
cd ~/Desktop && curl -L -o temp_exam_mac.zip "https://github.com/CNH3148/mt-exam-helper/releases/download/v3.0.115-2/MT_Exam_Prep_Portable_v3.0.115-2_Mac-Beta.zip" && unzip -q temp_exam_mac.zip -d 醫檢師刷題系統_Mac && rm temp_exam_mac.zip && xattr -cr 醫檢師刷題系統_Mac
```
